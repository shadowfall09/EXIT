#!/usr/bin/env python3
"""
Test script for Semantic Sentence Cover RAG Pipeline
Tests the Semantic Sentence Cover compression method on multiple datasets.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Test Semantic Sentence Cover RAG")
    ...
    parser.add_argument(
        ...
        help="Embedding model for Semantic Sentence Cover"
    )
    parser.add_argument(
        "--reader_model",
        type=str,
    ...
    # Semantic Sentence Cover arguments
    parser.add_argument(
        "--query_expansion_min",
        type=int,
        default=10,
        help="Minimum number of sentences for query expansion"
    )
    parser.add_argument(
        "--query_expansion_ratio",
        type=float,
        default=0.1,
        help="Ratio of sentences to include in query expansion (default: 0.1 = 10%)"
    )
    parser.add_argument(
        "--document_sampling_ratio",
        type=float,
        default=0.15,
        help="Ratio of sentences to select for compression (default: 0.15 = 15%)"
    )
    parser.add_argument(
        "--dedup_threshold",
        type=float,
        default=0.95,
        help="Similarity threshold for de-duplicating near-identical sentences (default: 0.95, set to 1.0 to disable)"
    )
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="./outputs/semantic_sentence_cover_results",
    ...
    print("Initializing Semantic Sentence Cover compressor...")
    compressor = SemanticSentenceCoverCompressor(
        embedding_model=args.embedding_model,
        device=device,
        query_expansion_min=args.query_expansion_min,
        query_expansion_ratio=args.query_expansion_ratio,
        document_sampling_ratio=args.document_sampling_ratio,
